...
get_metadata <- function(acc_number) {
  ...
  tryCatch({
    # Busca o registro no banco 'nuccore' (nucleotídeos) em formato GenBank
...
arquivo_entrada <- "C:/Users/luciano.kalabric/Downloads/sequence.seq"

# 2. Ler a lista de acessos
...
# 3. Executar a busca para todos os acessos do arquivo
...
# 5. Salvar o resultado final em uma tabela CSV
write_csv(df_resultados, "C:/Users/luciano.kalabric/Downloads/HDV_protein_4272_metadados.csv")
cat("\nProcesso concluído! Arquivo salvo como 'HDV_Lista_completa_acclist2metadata.csv'.\n")
